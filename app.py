...
def main():
    ...
    #     st.sidebar.write("dhruvranka7@gmail.com")

    # # Button for phone
    # if st.sidebar.button("Phone"):
    #     st.sidebar.write("9999999999")

    # Improved spacing and use of markdown for enhanced visual appeal
    st.markdown(
        """
<style>
...
div.stButton > button:hover {
    ...
    if selected == "Email":
        st.sidebar.code("akarshankap@gmail.com")

    elif selected == "Phone":
        st.sidebar.code("+91 7777034045")
